...
class BotHandler:
    ...
    def __init__(self, token):
        self.token = token
        self.api_url = "https://api.telegram.org/bot1343961372:AAE-bqYRPMjtE-4xFrFKlYTPnRMgmdgOvBc/".format(token)
...
token = "1343961372:AAE-bqYRPMjtE-4xFrFKlYTPnRMgmdgOvBc"
